...
ce_countries = ["Sao Paulo","Rio de Janeiro","Salvador","Brasilia","Fortaleza","Belo Horizonte","Manaus","Curitiba","Recife"]
#print(ce_countries)

# CREAR UN NUEVO DF CON LAS CIUDADES SELECCIONADAS
ce_cities = df[df["capital"].isin(ce_countries)].reset_index(drop=True)
...
# ESCRIBIR LOS PATHS (senderos) ENTRE LAS CIUDADES
